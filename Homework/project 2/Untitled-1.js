...
var pulseScale = 0.1;	//pulse scale
...
function render(){   
	...
	var cCenter = vec4(avg_x,avg_y,avg_z,1.0);
...
function process_keypress(theKey) {
	...
	var outputMessage = 'Current keypress actions are: <br>';
	...
	outputMessage += "-- ' D ' or ' d ' Draw normal lines. <br>";
